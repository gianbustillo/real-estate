...
try:
    ...
    while craigs_url != '':
        ...
        rent_1_bd_h = list(set(rent_1_bd) - set(rent_1_bd_c) - set(rent_1_bd_th))
        rent_2_bd_h = list(set(rent_2_bd) - set(rent_2_bd_c) - set(rent_2_bd_th))
        rent_3_bd_h = list(set(rent_3_bd) - set(rent_3_bd_c) - set(rent_3_bd_th))
        rent_4_bd_h = list(set(rent_4_bd) - set(rent_4_bd_c) - set(rent_4_bd_th))
        rent_5_bd_h = list(set(rent_5_bd) - set(rent_5_bd_c) - set(rent_5_bd_th))
        rent_6_bd_h = list(set(rent_6_bd) - set(rent_6_bd_c) - set(rent_6_bd_th))

        rent_1_count_h = rent_1_count - rent_1_count_c - rent_1_count_th
        rent_2_count_h = rent_2_count - rent_2_count_c - rent_2_count_th
        rent_3_count_h = rent_3_count - rent_3_count_c - rent_3_count_th
        rent_4_count_h = rent_4_count - rent_4_count_c - rent_4_count_th

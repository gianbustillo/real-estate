...
try:
    ...
    overall_filename = 'cities_list_baltimore.csv'
    ...
    while craigs_url != '':
        ...
        if not_found != -1:
            ...
            if os.path.exists(folder_and_file) == False:
                ...
                header100 = header1 + header4 + header5 + header6 + header7 + header8 + header9 + header10 + header11
...
os.system('updating_cities_baltimore.py')
